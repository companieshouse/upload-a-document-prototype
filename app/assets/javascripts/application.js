...
(function webpackUniversalModuleDefinition (e, t) {
  typeof exports === 'object' && typeof module === 'object' ? module.exports = t() : typeof define === 'function' && define.amd ? define([], t) : typeof exports === 'object' ? exports['accessibleAutocomplete'] = t() : e['accessibleAutocomplete'] = t()
})(window, function () {
  return (function (n) {
    var r = {}
    ...
    var m = n(1),
      ...
      w = function (e, t, n) {
        var r, o, i, u, a = e & w.F,
          ...
          d = s ? v : v[t] || (v[t] = {}),
          h = d[b] || (d[b] = {})
        for (r in s && (n = t), n) i = ((o = !a && f && f[r] !== undefined) ? f : n)[r], u = p && o ? _(i, m) : c && typeof i === 'function' ? _(Function.call, i) : i, f && g(f, r, i, e & w.U), d[r] != i && y(d, r, u), c && h[r] != i && (h[r] = i)
      }
    ...
    function r (e, t) {
      var n, r, o, i, u = c
      for (i = arguments.length; i-- > 2;) l.push(arguments[i])
      for (t && t.children != null && (l.length || l.push(t.children), delete t.children); l.length;) {
        if ((r = l.pop()) && r.pop !== undefined) {
            for (i = r.length; i--;) l.push(r[i])
          } else typeof r === 'boolean' && (r = null), (o = typeof e !== 'function') && (r == null ? r = '' : typeof r === 'number' ? r = String(r) : typeof r !== 'string' && (o = !1)), o && n ? u[u.length - 1] += r : u === c ? u = [r] : u.push(r), n = o
      }
      var a = new s()
      return a.nodeName = e, a.children = u, a.attributes = t == null ? undefined : t, a.key = t == null ? undefined : t.key, E.vnode !== undefined && E.vnode(a), a
    }
    ...
    function i (e, t) {
      return r(e.nodeName, M(M({}, e.attributes), t), arguments.length > 2 ? [].slice.call(arguments, 2) : e.children)
    }
    var p = /acit|ex(?:s|g|n|p|$)|rph|ows|mnc|ntw|ine[ch]|zoo|^ord/i,
      u = []

    function a (e) {
      !e._dirty && (e._dirty = !0) && u.push(e) == 1 && (E.debounceRendering || o)(f)
    }
    ...
    function v (e, t, n, r, o) {
      if (t === 'className' && (t = 'class'), t === 'key');
        ...
        if (t === 'style') {
            if (r && typeof r !== 'string' && typeof n !== 'string' || (e.style.cssText = r || ''), r && typeof r === 'object') {
              if (typeof n !== 'string') {
                for (var i in n) i in r || (e.style[i] = '')
              }
              for (var i in r) e.style[i] = typeof r[i] === 'number' && !1 === p.test(i) ? r[i] + 'px' : r[i]
            }
          } else if (t === 'dangerouslySetInnerHTML') r && (e.innerHTML = r.__html || '')
        else if (t[0] == 'o' && t[1] == 'n') {
            ...
            r != null && !1 !== r || t == 'spellcheck' || e.removeAttribute(t)
          } else {
            var a = o && t !== (t = t.replace(/^xlink:?/, ''))
            r == null || !1 === r ? a ? e.removeAttributeNS('http://www.w3.org/1999/xlink', t.toLowerCase()) : e.removeAttribute(t) : typeof r !== 'function' && (a ? e.setAttributeNS('http://www.w3.org/1999/xlink', t.toLowerCase(), r) : e.setAttribute(t, r))
          }
      } else e.className = r || ''
    }
    ...
    function B (e, t, n, r, o, i) {
      P++ || (j = o != null && o.ownerSVGElement !== undefined, L = e != null && !('__preactattr_' in e))
      var u = D(e, t, n, r, i)
    ...
    function D (e, t, n, r, o) {
      var i = e,
        u = j
      if (t != null && typeof t !== 'boolean' || (t = ''), typeof t === 'string' || typeof t === 'number') return e && e.splitText !== undefined && e.parentNode && (!e._component || o) ? e.nodeValue != t && (e.nodeValue = t) : (i = document.createTextNode(t), e && (e.parentNode && e.parentNode.replaceChild(i, e), F(e, !0))), i['__preactattr_'] = !0, i
      var a = t.nodeName
      ...
      if (j = a === 'svg' || a !== 'foreignObject' && j, a = String(a), (!e || !N(e, a)) && (i = (function h (e, t) {
      ...
      return !L && c && c.length === 1 && typeof c[0] === 'string' && s != null && s.splitText !== undefined && s.nextSibling == null ? s.nodeValue != c[0] && (s.nodeValue = c[0]) : (c && c.length || s != null) && (function S (e, t, n, r, o) {
        var i, u, a, s, l, c = e.childNodes,
            p = [],
            f = {},
            d = 0,
            h = 0,
        ...
        if (m !== 0) {
            for (var g = 0; g < m; g++) {
              ...
              w != null ? (d++, f[w] = _) : (b || (_.splitText !== undefined ? !o || _.nodeValue.trim() : o)) && (p[v++] = _)
            }
          }
        if (y !== 0) {
            for (var g = 0; g < y; g++) {
              s = t[g], l = null
              var w = s.key
              if (w != null) d && f[w] !== undefined && (l = f[w], f[w] = undefined, d--)
              else if (h < v) {
                for (i = h; i < v; i++) {
                  if (p[i] !== undefined && (x = u = p[i], C = o, typeof (O = s) === 'string' || typeof O === 'number' ? x.splitText !== undefined : typeof O.nodeName === 'string' ? !x._componentConstructor && N(x, O.nodeName) : C || x._componentConstructor === O.nodeName)) {
                    l = u, p[i] = undefined, i === v - 1 && v--, i === h && h++
                    break
                  }
                }
              }
              l = D(l, s, n, r), a = c[g], l && l !== e && l !== a && (a == null ? e.appendChild(l) : l === a.nextSibling ? k(a) : e.insertBefore(l, a))
            }
          }
        var x, O, C
        if (d) {
      ...
      }(i, c, n, r, L || l.dangerouslySetInnerHTML != null)),
                (function m (e, t, n) {
                  var r
                  for (r in n) t && t[r] != null || n[r] == null || v(e, r, n[r], n[r] = undefined, j)
                  for (r in t) r === 'children' || r === 'innerHTML' || r in n && t[r] === (r === 'value' || r === 'checked' ? e[r] : n[r]) || v(e, r, n[r], n[r] = t[r], j)
                }(i, t.attributes, l)), j = u, i
    }

    function F (e, t) {
      var n = e._component
      n ? q(n) : (e['__preactattr_'] != null && e['__preactattr_'].ref && e['__preactattr_'].ref(null), !1 !== t && e['__preactattr_'] != null || k(e), h(e))
    }
    ...
    function U (e, t, n, r, o) {
      e._disable || (e._disable = !0, e.__ref = t.ref, e.__key = t.key, delete t.ref, delete t.key, typeof e.constructor.getDerivedStateFromProps === 'undefined' && (!e.base || o ? e.componentWillMount && e.componentWillMount() : e.componentWillReceiveProps && e.componentWillReceiveProps(t, r)), r && r !== e.context && (e.prevContext || (e.prevContext = e.context), e.context = r), e.prevProps || (e.prevProps = e.props), e.props = t, e._disable = !1, n !== 0 && (n !== 1 && !1 === E.syncComponentUpdates && e.base ? a(e) : V(e, 1, o)), e.__ref && e.__ref(e))
    }
      ...
      if (!e._disable) {
        ...
        if (e.constructor.getDerivedStateFromProps && (s = M(M({}, s), e.constructor.getDerivedStateFromProps(a, s)), e.state = s), d && (e.props = c, e.state = p, e.context = f, t !== 2 && e.shouldComponentUpdate && !1 === e.shouldComponentUpdate(a, s, l) ? y = !0 : e.componentWillUpdate && e.componentWillUpdate(a, s, l), e.props = a, e.state = s, e.context = l), e.prevProps = e.prevState = e.prevContext = e.nextBase = null, e._dirty = !1, !y) {
            ...
            if (typeof w === 'function') {
              ...
              u = m, (_ = v) && (u = e._component = null), (m || t === 1) && (u && (u._component = null), b = (function B (t, n, r, o, i, u) {
                P++ || (j = i != null && i.ownerSVGElement !== undefined, L = t != null && !('__preactattr_' in t))
                var a = D(t, n, r, o, u)
    ...
    M(g.prototype, {
      setState: function (e, t) {
        this.prevState || (this.prevState = this.state), this.state = M(M({}, this.state), typeof e === 'function' ? e(this.state, this.props) : e), t && this._renderCallbacks.push(t), a(this)
      },
    ...
    e.exports = n(3) ? function (e, t, n) {
      ...
      n(6).inspectSource = function (e) {
        ...
        return typeof this === 'function' && this[s] || o.call(this)
      })
    }, function (e, t) {
      ...
      e.exports = function (e, t) {
        if (!o(e)) return e
        var n, r
        if (t && typeof (n = e.toString) === 'function' && !o(r = n.call(e))) return r
        if (typeof (n = e.valueOf) === 'function' && !o(r = n.call(e))) return r
        if (!t && typeof (n = e.toString) === 'function' && !o(r = n.call(e))) return r
      ...
      e.exports = !o || n(4)(function () {
        ...
        return e[n] = 7, r.split('').forEach(function (e) {
          t[e] = e
        }), o({}, e)[n] != 7 || Object.keys(o({}, t)).join('') != r
      }) ? function (e, t) {
      ...
      e.exports = function (e) {
        var t
        return o(e) && (typeof (t = e.constructor) !== 'function' || t !== Array && !o(t.prototype) || (t = undefined), r(t) && (t = t[i]) === null && (t = undefined)), t === undefined ? Array : t
      }
    }, function (e, t, n) {
      'use strict'
      var r = n(0),
      ...
      var a = (function (n) {
        ...
        return t.isQueryAnOption = function (e, t) {
          ...
          return !Y() && this.props.autoselect
              ...
              })), this.state.focused !== -1 && (e.preventDefault(), this.handleOptionClick(e, this.state.focused))
              ...
              switch (u[e.keyCode]) {
                ...
                default:
                  (function t (e) {
                    return e > 47 && e < 58 || e === 32 || e === 8 || e > 64 && e < 91 || e > 95 && e < 112 || e > 185 && e < 193 || e > 218 && e < 223
              ...
              var e, i = this,
                ...
                K = H && H.toLowerCase().indexOf(O.toLowerCase()) === 0 && M ? O + H.substr(O.length) : '',
                Q = u + '__assistiveHint',
                z = S ? {
                  'aria-describedby': Q
                } : null
              return c && typeof (e = y({
                ...
                onBlur: this.handleInputBlur
                  ...
                  var n = (_ === -1 ? C === t : _ === t) && b === null ? ' ' + q + '--focused' : '',
                    r = t % 2 ? ' ' + q + '--odd' : '',
      ...
      e.exports = Object.create || function (e, t) {
        var n
        return e !== null ? (s[l] = o(e), n = new s(), s[l] = null, n[a] = e) : n = c(), t === undefined ? n : i(n, t)
      }
    }, function (e, t, n) {
      var u = n(8),
        a = n(9),
      ...
      e.exports = function (t, e, n) {
        ...
        }) && (s(String.prototype, t, i), a(RegExp.prototype, r, e == 2 ? function (e, t) {
      ...
      (t['default'] = o).defaultProps = {
        ...
        tResults: function (e, t) {
          return e + ' ' + (e === 1 ? 'result' : 'results') + ' ' + (e === 1 ? 'is' : 'are') + ' available. ' + t
        }
      }
    }, function (e, t, n) {
      'use strict'
